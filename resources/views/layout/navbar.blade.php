        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                        ...
                        <ul class="mega-dropdown-menu dropdown-menu row">
                            <li class="col-md-2">
                                ...
                                <div id="mega-menu-carousel-example">
                                    <div>
                                        <img class="rounded img-fluid mb-1" src="../../../dashboard/app-assets/images/slider/slider-2.png" alt="First slide"><a class="news-title mb-0" href="#">Poster Frame PSD</a>
              ...
              <img src="../../../dashboard/app-assets/images/portrait/small/avatar-s-19.png" alt="avatar"><i></i></span>
                        ...
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="#"><i class="ft-user"></i> Edit Profile</a>
                            ...
                            <div class="dropdown-divider"></div><a class="dropdown-item" href="{{ route('signout') }}"><i class="ft-power"></i> Logout</a>
                        </div>
                    </li>
            ...
            <span class="badge badge-pill badge-default badge-danger badge-default badge-up badge-glow">5</span>
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                      ...
                      <img src="../../../dashboard/app-assets/images/portrait/small/avatar-s-2.png" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                      ...
                      <time class="media-meta text-muted" datetime="2015-06-11T18:29:20+08:00">Tuesday</time>
                                ...
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        <div class="media-left">
                                            <span class="avatar avatar-sm avatar-online rounded-circle">
                      <img src="../../../dashboard/app-assets/images/portrait/small/avatar-s-3.png" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                      ...
                      <img src="../../../dashboard/app-assets/images/portrait/small/avatar-s-6.png" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
